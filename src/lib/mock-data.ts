...
export const mockProducts: VaccineProduct[] = [
  {
    ...
    storageRequirements: 'Ultra-low temperature freezer (-80°C to -60°C)',
  ...
  },
  {
    ...
    storageRequirements: 'Freezer storage (-25°C to -15°C)',
    administrationInstructions: 'Thaw before use. Stable at 2-8°C for 30 days.'
  },
  {
    id: 'VAC-003',
    name: 'Johnson & Johnson COVID-19 Vaccine',
    manufacturer: 'Johnson & Johnson',
    batchNumber: 'JJ-2024-003',
    lotNumber: 'LOT-JJ456',
    ...
    totalDoses: 1000,
    remainingDoses: 750,
    qrUri: 'https://vaccine-track.example.com/qr/VAC-003',
    creator: '0x1234567890abcdef1234567890abcdef12345678',
    ...
    storageRequirements: 'Refrigerator storage (2°C to 8°C)',
    administrationInstructions: 'Single-dose administration. Ready to use.'
  }
];
...
export const mockAlerts: VaccineAlert[] = [
  {
    ...
    message: 'Temperature above optimal range (-65°C)',
